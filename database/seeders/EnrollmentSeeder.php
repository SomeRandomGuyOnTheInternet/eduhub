...
class EnrollmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $enrollments = [
            ...
            ['student_id' => 7, 'module_id' => 7, 'enrollment_date' => '2024-06-05'],
            ['student_id' => 8, 'module_id' => 8, 'enrollment_date' => '2024-06-05'],
            ['student_id' => 9, 'module_id' => 9, 'enrollment_date' => '2024-06-06'],
            ['student_id' => 9, 'module_id' => 10, 'enrollment_date' => '2024-06-06'],
            ...
            ['student_id' => 7, 'module_id' => 8, 'enrollment_date' => '2024-06-08'],
            ['student_id' => 8, 'module_id' => 9, 'enrollment_date' => '2024-06-08'],
        ];
