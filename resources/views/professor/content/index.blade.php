                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($folder->contents as $content)
                                    <tr>
                                        <td><a
                                                href="{{ route('modules.content.professor.show', ['module_id' => $module->module_id, 'content_id' => $content->content_id]) }}">{{ $content->title }}</a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <form
                                                action="{{ route('modules.content.professor.delete-content', ['module_id' => $module->module_id, 'content_id' => $content->content_id]) }}"
