            ...
            @foreach ($questions as $index => $question)
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="answers[{{ $index }}]" id="option_a_{{ $index }}"
                            value="A" required>
                        <label class="form-check-label" for="option_a_{{ $index }}">{{ $question->option_a }}</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="answers[{{ $index }}]" id="option_b_{{ $index }}"
                            value="B" required>
                        <label class="form-check-label" for="option_b_{{ $index }}">{{ $question->option_b }}</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="answers[{{ $index }}]" id="option_c_{{ $index }}"
                            value="C" required>
                        <label class="form-check-label" for="option_c_{{ $index }}">{{ $question->option_c }}</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="answers[{{ $index }}]" id="option_d_{{ $index }}"
                            value="D" required>
